# Generated by Powerlevel10k configuration wizard on 2020-03-18 at 21:08 JST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 50305.
# Wizard options: awesome-fontconfig, large icons, classic, dark, time, blurred tails,
# 2 lines, solid, right frame, sparse, many icons, concise.
