# Generated by Powerlevel10k configuration wizard on 2020-03-18 at 04:06 JST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 41746.
# Wizard options: awesome-fontconfig, large icons, classic, dark, time, flat tails,
# 2 lines, solid, right frame, sparse, many icons, concise, instant_prompt=quiet.
